...
$sql_select5 = "SELECT * FROM engmn_bots ORDER BY id + 0 DESC";
	...
	<section class="errors_scr">
		...
		<div class="card-head">
			...
			<h4 class="card-title card-title-lg mob-t" style='float:left; padding-top:8px;'>Боты</h4>
                      ...
                      <button class="btn-ccc btn btn-sm btn-outline btn-light input-bordered col-12" style="float:right; width:120px" onclick="deleteAllBot();return false;">Удалить всё</button><br><br>
            <hr>          
		</div>
                     <div class="card-text"> 
  ...
  <div class="modal-wrap" aria-hidden="true" role="dialog">
    ...
    <div class="modal-dialog">
      <div class="modal-header">
		...
		<h5>Бот может добавиться не сразу, нужно нажать на кнопку несколько раз!</h5>
        <label class="btn-close" for="modal-1" aria-hidden="true">×</label>
      </div>
      <div class="modal-body">
         Логин
<input type='text' class='input-bordered col-12' id='botname' value='' placeholder='Логин бота'><br>
    Мин. ставка
<input type='text' class='input-bordered col-12' id='botmin' value='' placeholder='Минимальная ставка'><br>
    Макс. ставка
<input type='text' class='input-bordered col-12' id='botmax' value='' placeholder='Максимальная ставка'><br>
    <!-- ОПОВЕЩЕНИЯ -->
...
beforeSend: function() {
             ...
             showModal("Вы удалили всех ботов!", 'green');
