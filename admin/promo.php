...
$sql_select5 = "SELECT * FROM engmn_promo ORDER BY id + 0 DESC";
...
<div class="card-innr">
		<div class="card-head">
			...
			<h4 class="card-title card-title-lg mob-t" style='float:left; padding-top:8px;'>Промокоды</h4>
                     <label class="btn-ccc btn btn-sm btn-outline btn-light input-bordered col-12" style="float:right; width:120px" for="modal-2">Добавить</label><br><br>
            <hr>          
		</div>
                     <div class="card-text"> 
...
<div class="modal">
  ...
  <div class="modal-wrap" aria-hidden="true" role="dialog">
    ...
    <div class="modal-dialog">
	  ...
	  <h5>Если промокод не создался с первого нажатия,
	 попробуйте кликнуть ещё несколько раз</h5>
      <div class="modal-body">
     
	 Название
<input type='text' class='input-bordered col-12' id='promoname' value='' placeholder='Название промокода'><br>
    Сумма
<input type='text' class='input-bordered col-12' id='promosum' value='' placeholder='Сумма промокода'><br>
   Кол-во активаций
<input type='text' class='input-bordered col-12' id='promoact' value='' placeholder='Кол-во активаций промокода'><br>
    <!-- ОПОВЕЩЕНИЯ -->
