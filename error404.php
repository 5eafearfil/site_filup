...
@media (min-width: 0px) and (max-width: 670px) {body{background: url('/img/<?=$snowFon?>.png') 0 -115px no-repeat !important;}
	...
	<section class="errors_scr">
				<h2 class="sucess_title" style=" text-transform: uppercase; font-size: 21px;">Ошибка #404</h2>
				<p class="erors_txt">Страница не найдена. Возможно,что вы допустили ошибку в ссылке.
					  Перейдите на главную страницу</p>
				<a href="/" class="auth_btn" style="margin-top: 10px;">Перейти на главную</a>
	</section>
