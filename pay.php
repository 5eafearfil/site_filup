...
$ava = "http://" . $_SERVER['HTTP_HOST'] . "/img/User.png";
				...
				$sql_select5 = "SELECT * FROM engmn_payments WHERE user_id = $id ORDER BY id DESC LIMIT 5";
...
<?=$snow?>	<link rel="prefetch" href="/img/BG_footer.png">
	...
	<title><?=$sitename?> | Пополнение баланса</title>
	<meta name="description" content="Пополнение баланса">
	<link rel="canonical" href="<?=$url?>/profile">
	<meta property="og:title" content="<?=$sitename?> | Пополнение баланса"> 
    <meta property="og:type" content="Website">
    <meta property="og:url" content="<?=$url?>/profile">
    <meta property="og:locale" content="ru_RU">
    <meta property="og:image" content="/img/on.png">
    <meta property="og:description" content="Пополнение баланса">
			...
			<form id="wind" method="POST" action="" class="cons_form">
				<aside class="cons_form_ass">
					<label for="cons" class="cons_form_ass_label">
						...
						<input maxlength="5" min="1" oninput="this.value = this.value.replace(/\D/g, '')" type="text" placeholder="Введите от 1 D." name="money" id="depositSize" class="cons_form_ass_label_inp setMoney">
					</label>
					<label for="cons" class="cons_form_ass_label">
...
.pay-option-check:checked ~ label {
    box-shadow: rgba(145, 192, 255, 0.29) 2px 2px 20px 0px;
    border-color: #2c80ff
}
    ...
    opacity: 0
		...
		<section class="cons_system cons_system__width">
                ...
                <ul class="pay-list guttar-15px">
                    <input id='systemPay' value="1" style="display:none"></input>
					...
					<div class="cons_system_block"><button id="depositButton" onclick="deposit_default();return false;" class="cons_system_block_btn" style="width:350px;height: 100px;box-shadow: 0 5px 23px 0 rgba(0, 125, 255, 0.3);margin-left:25%;font-size:25px;">Далее</button> 
					
					 
					
					<p class="cons_system_block_btn_txt">
					
						*Пополнение баланса может занять до 10 мин.
...
font-size: 3px;
	...
	<thead style="margin-bottom: 20px;">
		<tr class="payouts_head">
			...
			<th class="payouts_head_txt" style="width: 280px;">Дата</th>
...
while($row = mysql_fetch_array($result5)) {
  $sum = $row['suma'];
  $data = $row['data'];
 echo "<tr><td style='width: 100px;'><center>$sum</center></td><td style='width: 100px;'><center>$data</center></td></tr>";
